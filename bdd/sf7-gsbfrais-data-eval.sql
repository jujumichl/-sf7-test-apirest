...
INSERT INTO SecteurGeographique (id, libelle) VALUES
(1, 'Rennes Nord-Est'),
(2, 'Rennes Nord-Ouest'),
(3, 'Rennes Sud-Est'),
(4, 'Rennes Sud-Ouest');
INSERT INTO Visiteur (id, nom, prenom, login, mdp, adresse, cp, ville, dateEmbauche, SecteurGeographique_id) VALUES
('a17', 'Andre', 'David', 'dandre', 'oppg5', '1 rue Petit', '46200', 'Lalbenque', '1998-11-23', 1),
('a55', 'Bedos', 'Christian', 'cbedos', 'passe', '1 rue Peranud', '46250', 'Montcuq', '1995-01-12', 4);
