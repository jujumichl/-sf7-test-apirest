...
class Visiteur implements UserInterface, PasswordAuthenticatedUserInterface 
{
    ...
    public function addRoleUtilisateur(Role $roleUtilisateur): static
    {
        if (!$this->RolesUtilisateur->contains($roleUtilisateur)) {
            $this->RolesUtilisateur->add($roleUtilisateur);
        }

        return $this;
    }

    public function removeRoleUtilisateur(Role $roleUtilisateur): static
    {
        $this->RolesUtilisateur->removeElement($roleUtilisateur);
